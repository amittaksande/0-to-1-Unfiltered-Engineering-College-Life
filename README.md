...
I like to call the first year the "honeymoon period" of engineering life. Almost everyone enters college with excitement, curiosity, and a head full of expectations. Some students come from cities like Chandrapur, Gondia, Amravati, and other nearby towns, while many are from Nagpur itself ( talking about PCE ). Regardless of where they come from, most students arrive believing that college is going to completely change their lives.

You'll meet students with all kinds of mindsets. Some are convinced that no matter what happens, they'll graduate with the highest package. Some already dream of starting a business(next elon musk). Few have clear plans for GATE or government jobs. And then there are those who honestly never wanted to do engineering in the first place but joined because their parents encouraged—or forced—them to.

The first year is usually when you make the largest number of friends. You'll spend hours in classrooms, canteens, practical labs, and college corridors getting to know people from different backgrounds. Some of these friendships will last all four years, while others will disappear by the next upcoming year.
...
If first year was the honeymoon period, then second year is where reality slowly starts knocking on your door.

By now, you've entered your respective departments with a lot of excitement. You finally get to study the branch you chose. Most students believe that from this point onward they'll learn fascinating things about their field, understand how real-world systems work, and start feeling like actual engineers.

Unfortunately, for many students, things don't go exactly as planned.

Almost every subject is new. The terminology is new, the concepts are new, and sometimes even the teaching style feels completely different from what you're used to. There will be lectures where you'll sit for an hour and walk out wondering what exactly was taught. Many students experience their lowest CGPA somewhere around this phase because the transition from first-year common subjects to branch-specific subjects is not always smooth.

At the same time, something interesting starts happening. You slowly begin exploring your boundaries. Some students start coding. Some prepare for competitive programming. Some participate in technical events and workshops. Some discover GATE. only few are thinking about MBA, government exams, higher studies, freelancing, startups, or internships. Most of the time, you're exploring these options with very limited knowledge, trying to figure out what is actually right for you.

This is also the year when you realize that everyone seems to be doing something different. One friend is learning web development, another is preparing for GATE, someone is focusing on sports, and someone else is already talking about startups. (But eventually by end of 4th year you will understand no one is doing extraordinary or really passionate about it. Just doing as you supposed to do)

The truth is that second year is less about mastering a skill and more about discovering what interests you. You'll try many things, quit some of them, fail at others, and hopefully find one or two areas that genuinely excite you.
...
This is usually the year when many students suddenly realize how far behind they are in the placement race. The same students who spent the first two years saying "abhi toh time hai" now discover that placements are not very far away. Suddenly everyone seems to be learning something. One friend is solving DSA questions, another is building projects, someone is learning web development, someone is preparing for aptitude tests, and someone else is already talking about internships and referrals.

For many students, this is when panic begins.

You start enrolling in programming courses, learning development, building projects, improving your resume, and trying to understand what exactly companies expect from a candidate. It often feels like time is running faster than before. You look back and think, "How did two years pass so quickly?" and then realize that only a limited amount of time is left before placements begin.

At the same time, third year is not just about careers.

This is also the period when many students become active in departmental forums, technical clubs, cultural bodies, and student organizations. Some get selected for leadership positions and proudly update their LinkedIn profiles and Instagram stories with "Selected as XYZ Coordinator" or "Appointed as XYZ Head." Some start hosting events, managing college activities, organizing freshers' programs for juniors, and interacting more closely with seniors and faculty members.

Your friend circle also starts becoming smaller. Not because of fights, but because people become busy with different goals. Everyone is moving in a different direction. Some are focused on placements, few of them GATE, most of them are still trying to figure out what they want to do after graduation.

This is also the year of college trips, late-night discussions about careers, group projects, internship applications, and countless conversations that begin with, "Bro, what are your plans after engineering?"You'll notice different types of students around you. Some start preparing seriously for placements. Some pay for internships just to gain experience and build their resumes. few begin dedicated GATE preparation.

And then there is the largest group—the students who are still living in a comfortable illusion. They know placements are coming. They know skills are important. They know competition exists. But they keep postponing action because somewhere deep down they believe there is still plenty of time.
...
Now everything feels like it's coming to an end.

There is nothing new left to discover, only unfinished battles to fight. You suddenly realize how fast four years have passed. It feels like yesterday when you entered the college gates as a nervous first-year student, and now you are standing at the edge of graduation.

This is the phase where reality hits the hardest.

The college project begins, and everyone expects your project to be unique, innovative, and something that can change the world—because after all, you are an engineer. But deep inside, many students feel completely helpless. confidence starts fading, and every decision feels heavier than before.

At the same time, placement season arrives.

The pressure is at its peak. You have to prepare for aptitude tests, coding rounds, interviews, college lectures, assignments, and semester exams—all at once. Every day feels like a race against time. You want to work hard, but most days end in confusion. There are countless courses to complete, skills to learn, and topics to revise, yet you don't know where to begin.

Slowly, you start distancing yourself from the friends who were once part of your everyday life. Not because you dislike them, but because everyone is fighting their own battle now.The dreams you saw in the first year begin to collide with reality. The startup you wanted to build, the revolutionary app you planned to create, the grand vision of becoming the next tech icon—all seem much farther away than they once did.

And then comes the most painful thought:"What if I am just average?"

After four years of engineering, many students feel they have no extraordinary skills, no remarkable achievements, and no clear direction. The confidence that once existed is replaced by self-doubt and society pressure.

The dream package is gone.
The dream company is gone.
And suddenly, the only option left seems to be a ₹4 LPA job.But this is where most students misunderstand the story.Final year is not the chapter where dreams end.It is the chapter where illusions end.
...
Amit Bhaiya is here to share a few things that four years of engineering have taught him—lessons that don't appear in placement statistics, salary packages, or LinkedIn posts.
...
It is for those who have bigger Aim in life.(a good package)<br>
It is for those who refuse to settle for an average life.<br>
...
80+ marks → AIR under 40<br>
70+ marks → AIR under 300<br>
60+ marks → AIR under 1000<br>
53+ marks → AIR under 3000<br>
...
𝐈𝐟 𝐭𝐡𝐢𝐬 𝐛𝐥𝐨𝐠 𝐠𝐚𝐯𝐞 𝐲𝐨𝐮 𝐬𝐨𝐦𝐞 𝐜𝐥𝐚𝐫𝐢𝐭𝐲, 𝐭𝐡𝐞𝐫𝐞 𝐦𝐚𝐲 𝐛𝐞 𝟏% 𝐜𝐡𝐚𝐧𝐜𝐞 𝐚𝐧𝐨𝐭𝐡𝐞𝐫 𝐬𝐭𝐮𝐝𝐞𝐧𝐭 𝐣𝐮𝐬𝐭 𝐥𝐢𝐤𝐞 𝐲𝐨𝐮 𝐰𝐡𝐨 𝐢𝐬 𝐜𝐨𝐧𝐟𝐮𝐬𝐞𝐝 𝐚𝐧𝐝 𝐥𝐨𝐨𝐤𝐢𝐧𝐠 𝐟𝐨𝐫 𝐠𝐮𝐢𝐝𝐚𝐧𝐜𝐞. 𝐉𝐮𝐬𝐭 𝐜𝐨𝐩𝐲 𝐭𝐡𝐞 𝐥𝐢𝐧𝐤 𝐛𝐞𝐥𝐨𝐰 𝐚𝐧𝐝 𝐬𝐡𝐚𝐫𝐢𝐧𝐠 𝐢𝐭 𝐢𝐧 𝐲𝐨𝐮𝐫 𝐜𝐨𝐥𝐥𝐞𝐠𝐞 𝐮𝐧𝐨𝐟𝐟𝐢𝐜𝐢𝐚𝐥 𝐠𝐫𝐨𝐮𝐩𝐬.𝐑𝐞𝐦𝐞𝐦𝐛𝐞𝐫, 𝐞𝐯𝐞𝐫𝐲𝐭𝐡𝐢𝐧𝐠 𝐢𝐬 𝐢𝐧𝐭𝐞𝐫𝐜𝐨𝐧𝐧𝐞𝐜𝐭𝐞𝐝. 𝐖𝐡𝐚𝐭𝐞𝐯𝐞𝐫 𝐠𝐨𝐨𝐝 𝐰𝐞 𝐝𝐨 𝐟𝐨𝐫 𝐨𝐭𝐡𝐞𝐫𝐬 𝐞𝐯𝐞𝐧𝐭𝐮𝐚𝐥𝐥𝐲 𝐜𝐨𝐦𝐞𝐬 𝐛𝐚𝐜𝐤 𝐭𝐨 𝐮𝐬. <br>
<br>
https://shorturl.at/hmvl8 <br>
